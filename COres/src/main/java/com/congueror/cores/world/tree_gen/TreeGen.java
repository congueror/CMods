package com.congueror.cores.world.tree_gen;
...
public class TreeGen {
    ...
    public static void registerTreeFeature() {
        RUBBER = registerTree(COres.MODID, "rubber_tree", Feature.TREE.withConfiguration(new BaseTreeFeatureConfig.Builder(
