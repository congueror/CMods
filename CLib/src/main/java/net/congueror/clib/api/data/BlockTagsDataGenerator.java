...
public class BlockTagsDataGenerator extends BlockTagsProvider {
    ...
    public BlockTagsDataGenerator(DataGenerator generatorIn, String modId, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags() {
        BlockBuilder.OBJECTS.forEach(block -> {
            for (Map.Entry<String, Tag.Named<Block>> tags : block.blockTags.entrySet()) {
                tag(tags.getValue()).add(block.getBlock());
            }
