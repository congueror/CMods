...
public class LootTableDataGenerator extends LootTableProvider implements DataProvider {//net.minecraft.data.loot.BlockLoot
    ...
    public LootTableDataGenerator(DataGenerator pGenerator) {
        super(pGenerator);
    }
    ...
    protected List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet>> getTables() {
        ...
        BlockBuilder.OBJECTS.forEach(builder -> {
            if (builder.lootTable != null) {
                builder.lootTable.accept(this, builder.getBlock());
            } else {
                createStandardBlockDrop(builder.getBlock());
            }
        });
        return tables;
    }
