...
/**
 * An interface which can be implemented by an Item class to add additional functionality for the {@link ItemBuilder}. See {@link CLItem} for example on how to implement properly
 */
