...
public abstract class AbstractItemMachineScreen<T extends AbstractItemMachineContainer<?>> extends AbstractContainerScreen<T> {
    protected T container;
    public static final int elementWidth = 56;
    public static final int elementHeight = 60;

    public AbstractItemMachineScreen(T pMenu, Inventory pPlayerInventory, Component pTitle) {
