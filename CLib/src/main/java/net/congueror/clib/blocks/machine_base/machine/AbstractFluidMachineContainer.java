...
public abstract class AbstractFluidMachineContainer<T extends AbstractFluidMachineBlockEntity> extends AbstractItemMachineContainer<T> {
    protected NonNullList<FluidStack> fluidLastTick = NonNullList.create();

    public AbstractFluidMachineContainer(@Nullable MenuType<?> type, int id, Player player, Inventory playerInventory, T tile, ContainerData dataIn) {
