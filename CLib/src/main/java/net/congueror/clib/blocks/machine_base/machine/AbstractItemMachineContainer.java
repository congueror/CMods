...
public abstract class AbstractItemMachineContainer<T extends AbstractItemMachineBlockEntity> extends AbstractInventoryContainer {
    protected T tile;
    ContainerData data;
    protected Player player;
    protected String infoLastTick;

    protected AbstractItemMachineContainer(@Nullable MenuType<?> type, int id, Player player, Inventory playerInventory, T tile, ContainerData dataIn) {
