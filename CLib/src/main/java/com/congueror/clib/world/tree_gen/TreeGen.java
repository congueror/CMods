...
public class TreeGen {
    ...
    public static void registerTreeFeature() {
        RUBBER = register("rubber_tree", Feature.TREE.withConfiguration(new BaseTreeFeatureConfig.Builder(
    ...
    public static <FC extends IFeatureConfig> ConfiguredFeature<FC, ?> register(String name, ConfiguredFeature<FC, ?> feature) {
        return Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(CLib.MODID, name), feature);
    }
