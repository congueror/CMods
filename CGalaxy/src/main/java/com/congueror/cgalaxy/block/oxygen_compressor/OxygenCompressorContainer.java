...
public class OxygenCompressorContainer extends AbstractFluidContainer<OxygenCompressorTileEntity> {
    OxygenCompressorTileEntity te;

    public OxygenCompressorContainer(int id, PlayerInventory playerInventory, OxygenCompressorTileEntity tile, IIntArray dataIn) {
        super(ContainerInit.OXYGEN_COMPRESSOR.get(), id, playerInventory, tile, dataIn);
        this.te = tile;
