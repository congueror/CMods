...
public class OxygenCompressorScreen extends ContainerScreen<OxygenCompressorContainer> {
    ...
    public OxygenCompressorScreen(OxygenCompressorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i = 0; i < container.getFluidTanks().length; i++) {
            ...
            this.renderHoveredTooltip(matrixStack, mouseX, mouseY);
            if (mouseX > guiLeft + 101 && mouseX < guiLeft + 118 && mouseY > guiTop + 17 && mouseY < guiTop + 69 && i == 0) {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        String title = new TranslationTextComponent("block.cgalaxy.oxygen_compressor").getString();
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        this.blit(matrixStack, this.guiLeft + 77, this.guiTop + 38, 196, 0, length + 1, 16);
