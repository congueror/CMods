...
public class JeiCompat implements IModPlugin {
    ...
    protected static final ResourceLocation FUEL_LOADING = new ResourceLocation(CGalaxy.MODID, "fuel_loading");
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(getRecipes(RecipeSerializerInit.Types.FUEL_LOADING), FUEL_LOADING);
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(BlockInit.FUEL_LOADER.get()), FUEL_LOADING);
    }
}
