...
public class GalaxyMapGui extends Screen {
    ...
    protected void init() {
        ...
        this.LAUNCH_MERCURY = addButton(new ImageButton(26, 150, 85, 20, 0, 0, 0, new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/blank.png"), 85, 20, p_onPress_1_ -> {
        ...
        this.LAUNCH_VENUS = addButton(new ImageButton(26, 150, 85, 20, 0, 0, 0, new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/blank.png"), 85, 20, p_onPress_1_ -> {
            if (entity instanceof RocketEntity) {
                //tp to venus
            }
        }));
        ...
        this.LAUNCH_EARTH = addButton(new ImageButton(26, 140, 85, 20, 0, 0, 0, new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/blank.png"), 85, 20, p_onPress_1_ -> {
            System.out.println(player.world.getDimensionKey());
            System.out.println(player.worldClient.getDimensionKey());
            System.out.println(entity);
            if (entity instanceof RocketEntity && player.worldClient.getDimensionKey() != World.OVERWORLD) {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (CURRENT_MAP == 2) {
            ...
            //Mercury
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/mercury.png"));
            ...
            //Venus
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/venus.png"));
            ...
            //Earth
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/earth.png"));
            ...
            //Mars
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/mars.png"));
        ...
        if (CURRENT_MAP == 2.1) {
            ...
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/sky/mercury.png"));
            this.blit(matrixStack, 330, 133, 0, 0, 96, 96, 32, 32);
        ...
        if (CURRENT_MAP == 2.2) {
            ...
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/sky/venus.png"));
            this.blit(matrixStack, 330, 133, 0, 0, 96, 96, 32, 32);
        ...
        if (CURRENT_MAP >= 2.3 && CURRENT_MAP < 2.4) {
            ...
            mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/sky/earth.png"));
            this.blit(matrixStack, 330, 133, 0, 0, 96, 96, 32, 32);
            ...
            //Launch Button
            if (entity instanceof RocketEntity /*TODO tier1*/) {
                mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/launch_button_ul.png"));
            } else {
                mc.getTextureManager().bindTexture(new ResourceLocation(CGalaxy.MODID, "textures/gui/galaxy_map/launch_button.png"));
            }
