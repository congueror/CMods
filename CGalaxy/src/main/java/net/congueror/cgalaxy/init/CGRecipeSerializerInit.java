...
public class CGRecipeSerializerInit {
    ...
    public static final RegistryObject<RecipeSerializer<?>> OXYGEN_COMPRESSING = RECIPE_SERIALIZERS.register("oxygen_compressor", FuelRefineryRecipe.Serializer::new);
