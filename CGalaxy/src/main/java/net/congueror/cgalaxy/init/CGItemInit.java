...
public class CGItemInit {
    ...
    public static final RegistryObject<Item> SPACE_SUIT_HELM = new ItemBuilder("oxygen_mask",
            new OxygenMaskItem(SpaceSuitItem.SpaceSuitMaterial.MNORMAL, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeTabs.CGalaxyIG.instance)))
            .withItemModel(null)
            .withTranslation("Oxygen Mask")
            .build(ITEMS);
    public static final RegistryObject<Item> SPACE_SUIT_CHEST = new ItemBuilder("space_suit_chest",
            new SpaceSuitItem(SpaceSuitItem.SpaceSuitMaterial.NORMAL, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeTabs.CGalaxyIG.instance)))
            .withTranslation("Space Suit Top")
            .build(ITEMS);
    public static final RegistryObject<Item> SPACE_SUIT_LEGS = new ItemBuilder("space_suit_legs",
            new SpaceSuitItem(SpaceSuitItem.SpaceSuitMaterial.NORMAL, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeTabs.CGalaxyIG.instance)))
    ...
    public static final RegistryObject<Item> SPACE_SUIT_BOOTS = new ItemBuilder("space_suit_boots",
            new SpaceSuitItem(SpaceSuitItem.SpaceSuitMaterial.NORMAL, EquipmentSlot.FEET, new Item.Properties().tab(CreativeTabs.CGalaxyIG.instance)))
