...
public class OxygenTankModel<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(CGalaxy.MODID, "oxygen_tank"), "main");
    private final ModelPart Tank1;
    private final ModelPart Tank2;
    private final boolean two;

    public OxygenTankModel(ModelPart root, boolean twoTanks) {
