...
public class MoonOrbitEffects extends AbstractEffects {
    public MoonOrbitEffects() {
        super(CGalaxy.location("moon_orbit_effect"), Float.NaN, false, SkyType.NONE, false, false);
    }
    ...
    public ISkyRenderHandler getSkyRenderHandler() {
        return new AbstractSkyRenderer() {
            ...
            public void render(int ticks, float partialTicks, PoseStack poseStack, ClientLevel level, Minecraft mc) {
                ...
                ResourceLocation MOON = new ResourceLocation(CGalaxy.MODID, "textures/sky/moon_2.png");
