...
public class SealedItemCableBlock extends SealedCableBlock {
    public SealedItemCableBlock(Properties p_49795_) {
        super(p_49795_);
    }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        if (!pLevel.isClientSide) {
            ...
            if (stack.getItem() instanceof BlockItem bi && blockEntity instanceof SealedItemCableBlockEntity be) {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        return new SealedItemCableBlockEntity(pPos, pState);
    }
}
